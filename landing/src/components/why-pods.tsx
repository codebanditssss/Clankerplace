...
/**
 * Why pods — editorial layout. Giant italic pull quote on the left,
 * three numbered statements on the right. The section sits on a
 * slightly elevated dark surface so it reads as a chapter break.
 */
...
const POINTS = [
  {
    ...
    body: "Pelican Panel + Wings run inside your own Azure / Hetzner / bare-metal box. We never see your traffic, your prompts, or your model keys.",
  },
  {
    n: "02",
    title: "No middleman cloud.",
    body: "Pod data lives in /srv/pods/wings/volumes on your machine. No managed database, no telemetry pipe, no third-party inference relay sitting between you and the model.",
  },
  {
    n: "03",
    title: "One VM, many pods.",
    body: "A single 4-vCPU box runs Hermes + n8n + code-server + a Minecraft server side by side. Pay your cloud, not us. Hard-capped by docker, not by us.",
  },
];
          ...
          <figure className="flex flex-col gap-8 lg:col-span-5">
            ...
            <ul className="flex flex-col gap-0 font-mono text-[12px]">
              {[
                ...
                ["pelican",     "panel · auth · provisioning"],
                ["wings",       "docker · volumes · streams"],
                ["your pod",    "/home/container"],
              ].map(([k, v]) => (
                <li
                  key={k}
